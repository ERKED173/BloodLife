...
public class BLFont {
    ...
    public BLFont(String path, int charAmount, Color textColor, float borderWidth, Color borderColor, String FONT_CHARS_RU){
    ...
    public BLFont(String path, int charAmount, Color textColor, int shadowX, int shadowY, Color shadowColor, String FONT_CHARS_RU){
        FreeTypeFontGenerator gen = new FreeTypeFontGenerator(Gdx.files.internal(path));
        FreeTypeFontParameter param = new FreeTypeFontParameter();
        param.color = textColor;
        param.size = (int)(width/charAmount);
    ...
    public BLFont(String path, int charAmount, Color textColor, String FONT_CHARS_RU){
        FreeTypeFontGenerator gen = new FreeTypeFontGenerator(Gdx.files.internal(path));
        FreeTypeFontParameter param = new FreeTypeFontParameter();
        param.color = textColor;
        param.size = (int)(width/charAmount);
